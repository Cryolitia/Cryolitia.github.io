...
它还有一个非常私人的背景：当时我亲密关系对象的cn[^6]是「萤石」，也就是 *fluorite*。萤石（CaF₂）和冰晶石（Na₃AlF₆）都是氟化物，在元素组成和晶体世界里有一种很明确的亲缘关系。冰晶石在自然界中罕见，却在工业上承担着非常具体的作用——它是电解铝的助熔剂，能把氧化铝的熔点从约 2000°C 降到 950°C 左右。
